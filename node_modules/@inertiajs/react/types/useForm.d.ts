...
export interface InertiaFormValidationProps<TForm extends object> {
    ...
    validate: <K extends FormDataKeys<TForm>>(field?: K | NamedInputEvent | PrecognitionValidationConfig<K>, config?: PrecognitionValidationConfig<K>) => InertiaPrecognitiveFormProps<TForm>;
